...
En términos generales, la Estadía en \UnidadEconomica\ permitió aportar valor concreto a la Mesa de Servicio del CCoE, tanto en la verificación diaria de alertas como en el desarrollo de una herramienta de automatización que sigue funcionando después de concluida la Estadía. Más allá de los conocimientos técnicos adquiridos, esta experiencia representó una introducción real al trabajo en un entorno profesional de TI.
