...
\textit{Espacio breve (media cuartilla) para agradecer a las personas e instituciones que apoyaron durante la Estadía.}

\clearpage
\thispagestyle{fancy}
\addcontentsline{toc}{section}{Resumen}
\section*{Resumen}
\textit{Máximo una página: menciona la empresa, el problema detectado en el área de trabajo, qué actividades se realizaron para atenderlo y qué resultado se obtuvo. Redacción en tercera persona y tiempo pasado, sin tablas ni imágenes.}
...
\section*{Anexos}
\textit{Planos, manuales elaborados, formatos, códigos, hojas de datos, cronograma completo y cartas de evaluación (si aplica).}
