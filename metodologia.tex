...
La Figura \ref{fig:diagrama_flujo} resume la lógica que sigue la versión final del script en cada revisión (con el intervalo de 4 minutos y las mejoras descritas en Resultados).
