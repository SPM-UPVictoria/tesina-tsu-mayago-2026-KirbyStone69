...
El objetivo de automatizar el monitoreo de TIBCO Scribe se cumplió por completo: la versión final del script cubre incluso la regla del estado de error fatal, que en un inicio se seguía revisando de forma manual. En una jornada de 8 horas con una revisión cada 30 minutos son 16 rondas al día; a 6 o 7 minutos por ronda, la automatización libera alrededor de 105 minutos diarios, cerca de 35 horas al mes considerando 20 días laborales. Ese tiempo el equipo lo puede destinar a atender incidentes reales en lugar de revisiones repetitivas.
