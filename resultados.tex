...
La Figura \ref{fig:bot_estados} muestra los cuatro estados que el bot es capaz de detectar durante la revisión de cada solución, y la Figura \ref{fig:telegram_aviso} presenta avisos reales que el bot envió al grupo de Telegram del equipo durante la Estadía.
